  ...
  return (
    <>
      <style>{`
        ...
        @keyframes versePlay { from { background: rgba(96,165,250,0.35); } to { background: rgba(96,165,250,0.18); } }
        [data-verse-playing="true"] { animation: versePlay 0.5s ease-out forwards !important; border-left-color: #60A5FA !important; }
